...
nos interesará calcular probabilidades de eventos *condicionadas* 
...
evento "tirar al menos un 5", entonces
$$P(E|F) = 2/5$$
...
En un espacio de probabilidad, si $E$ y $F$ son eventos, definimos
...
Podemos también checar este resultado usando simulación 

## Ejercicio: dados y monedas (simulación)

Esta es la función que simula la tirada de dado y después las tiradas de monedas del
ejemplo anterior:
...
que coincide con nuestro resultado analítico anterior.
