...
muestra particular que obtuvimos. Sin embargo, es posible decir algo más informativo
de la población dado que extraímos una muestra de "típica" de probabilidad alta.
...
Ahora consideramos un dato $y$ extraído también al azar de la población. Entonces
es igualmente probable que $y$ caiga en cualquiera de los intervalos $I$. Para
...
tenemos una población de tamaño 20, y que tomamos una muestra de 8 elementos al azar. Los valores obtenidos, ordenados, son 12, 15, 16, 17, 18, 20, 23, 30, 32. Tenemos entonces 5 intervalos que considerar

Haciendo el paso 1, por ejemplo, que la población ordenada de chica a grande es:
...
```
En este caso, la mediana debería estar entre 20 y 30. Hagamos otra repetición:
...
Este proceso se llama remuestreo, y lo hacemos a continuación para nuestro ejemplo
