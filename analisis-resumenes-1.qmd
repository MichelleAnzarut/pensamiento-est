...
En esta parte establecemos las herramientas básicas que utilizaremos para
describir y explorar conjuntos de datos. En esta parte veremos cómo analizar
y comparar distintos *bonches* de datos numéricos.
...
- En la teoría, generalmente es más común utilizar la fda empírica, que nos
da una distribución de probabilidad acumulada.
...
los vuelve poco útiles en las primeras etapas de descripción.
