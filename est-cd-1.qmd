# Estadística y ciencia de datos {.unnumbered}
...
En un estudio de hospitales Australia se registró que
...
difícil genralizar para las personas no observadas en el estudio.

### Ejemplo: colisionadores 1 {.unnumbered}
...
general. Usaremos datos sintéticos (simulados).
...
### Ejemplo: colisionador 2 {.unnumbered}
