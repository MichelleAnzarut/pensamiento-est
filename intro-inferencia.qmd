...
tratamiento y cómo se relaciona con la calificación en Enlace (nota: hya muchas más
variables y estructuras causales que se pueden considerar, este es sólo un ejemplo
que nos indica cómo podría ser problemática una comparación directa entre tipo de escuelas):
...
a como se selecciona cada escuela para cada alumno, es complejo. 
- Hacer inferencia causal en este caso es retador y
depende de varios supuestos **que no son estadísticos**.


## Procesos generadores e inferencia a poblaciones

Supongamos que nos interesa estimar la prevalencia de anemia en menores
de edad escolar en México (6 a 15 años).
Si extraemos los registros de hospitalización del IMSS, por ejemplo, nos
encontramos con que 47% de los niños registrados tiene anemia. ¿Por qué esta
es una estimación dudosa (y demasiado alta) de la prevalencia en México de anemia en niños?

- La razón es que si un menor tienen una enfermedad grave es más probable
...
- Adicionalmente, la probabilidad de hospitalización para cada
tipo de enfermedad cambia con la edad.

Concluimos que:

- La probabilidad de selección en la muestra cambia dependiendo si un menor
tiene anemia o no. 

En conclusión, si no sabemos cómo es que otras enfermedades 
que llevan a la hospitalización influye en tener anemia en menores y cómo
la edad está relacionada con casos de anemia, será difícil
extraer conclusiones de estos datos. 

Este caso es muy claro por qué es difícil decir algo de la población general
de menores con la muestra de menores hospitalizados, y en muchos casos
este problema puede ser más sutil.
